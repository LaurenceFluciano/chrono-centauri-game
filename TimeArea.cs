...
public partial class TimeArea : Area2D
{
    ...
    private void OnEraChanged(Era newEra)
    {
        ...
        // CORREÇÃO: Altera o monitoramento da Area2D em vez de desativar o ProcessMode do nó
        Monitoring = isVisibleInEra;
        Monitorable = isVisibleInEra;
